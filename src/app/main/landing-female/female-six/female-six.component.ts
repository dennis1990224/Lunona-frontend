...
@Component({
  selector: 'app-female-six',
  templateUrl: './female-six.component.html',
  styleUrls: ['./female-six.component.scss']
})
export class FemaleSixComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    if (this.languagePublicElements) {
      this.TopRibbonContent = this.getTranslate("Public.Index.Women.Page6.TopRibbonContent");
