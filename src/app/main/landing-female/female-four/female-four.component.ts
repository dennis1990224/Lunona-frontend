...
@Component({
  selector: 'app-female-four',
  templateUrl: './female-four.component.html',
  styleUrls: ['./female-four.component.scss']
})
export class FemaleFourComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.languagePublicElements) {
      this.TopRibbonContent = this.getTranslate("Public.Index.Women.Page4.TopRibbonContent");
      this.AcquaintancesTitle = this.getTranslate("Public.Index.Women.Page4.AcquaintancesTitle");
      this.AcquaintancesDescription = this.getTranslate("Public.Index.Women.Page4.AcquaintancesDescription");
      this.TravelTitle = this.getTranslate("Public.Index.Women.Page4.TravelTitle");
      this.TravelDescription = this.getTranslate("Public.Index.Women.Page4.TravelDescription");
      this.JobTitle = this.getTranslate("Public.Index.Women.Page4.JobTitle");
      this.JobDescription = this.getTranslate("Public.Index.Women.Page4.JobDescription");
    }
  }
