...
@Component({
  selector: 'app-browse-online',
  templateUrl: './browse-online.component.html',
  styleUrls: ['./browse-online.component.scss'],
...
export class BrowseOnlineComponent implements OnInit {
  ...
  public getBrowseOnlineProfile(): void {
    this.isLoading = true;
  ...
  /** search world member */
  public searchNewWorldMember(): void {
