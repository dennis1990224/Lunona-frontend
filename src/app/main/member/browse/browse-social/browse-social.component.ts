...
@Component({
  selector: 'app-browse-social',
  templateUrl: './browse-social.component.html',
  styleUrls: ['./browse-social.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseSocialComponent implements OnInit {
  ...
  public command: string = "socialposition";
  ...
  public getBrowseSocialProfile(): void {
    this.isLoading = true;
