...
@Component({
  selector: 'app-browse-travel',
  templateUrl: './browse-travel.component.html',
  styleUrls: ['./browse-travel.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseTravelComponent implements OnInit {
  ...
  public getBrowseTravelProfile(): void {
    this.isLoading = true;
