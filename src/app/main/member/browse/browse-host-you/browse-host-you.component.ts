...
@Component({
  selector: 'app-browse-host-you',
  templateUrl: './browse-host-you.component.html',
  styleUrls: ['./browse-host-you.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseHostYouComponent implements OnInit {
  ...
  public command: string = "hostcity";
  ...
  public getBrowseHostCityProfile(): void {
    this.isLoading = true;
