...
@Component({
  selector: 'app-browse-country-arrivals',
  templateUrl: './browse-country-arrivals.component.html',
  styleUrls: ['./browse-country-arrivals.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseCountryArrivalsComponent implements OnInit {
  ...
  public command: string = "newlocal";
  ...
  public getBrowseNewLocalProfile(): void {
    this.isLoading = true;
