...
@Component({
  selector: 'app-browse-close-you',
  templateUrl: './browse-close-you.component.html',
  styleUrls: ['./browse-close-you.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseCloseYouComponent implements OnInit {
  ...
  public getBrowseCloseProfile(): void {
    this.isLoading = true;
