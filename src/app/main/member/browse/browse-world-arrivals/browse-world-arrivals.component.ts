...
@Component({
  selector: 'app-browse-world-arrivals',
  templateUrl: './browse-world-arrivals.component.html',
  styleUrls: ['./browse-world-arrivals.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BrowseWorldArrivalsComponent implements OnInit {
  ...
  public getBrowseNewWorldProfile(): void {
    this.isLoading = true;
