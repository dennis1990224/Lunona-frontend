...
@Component({
  selector: 'app-profile-by-kiss',
  templateUrl: './profile-by-kiss.component.html',
  styleUrls: ['./profile-by-kiss.component.scss']
})
export class ProfileByKissComponent implements OnInit {

  public token: string;
  public profiles: MemberItem[];
  public key: string = "THEM_WINK_ME";
