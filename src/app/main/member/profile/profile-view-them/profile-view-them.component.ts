...
@Component({
  selector: 'app-profile-view-them',
  templateUrl: './profile-view-them.component.html',
  styleUrls: ['./profile-view-them.component.scss']
})
export class ProfileViewThemComponent implements OnInit {
