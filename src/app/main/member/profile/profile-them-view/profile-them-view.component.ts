...
@Component({
  selector: 'app-profile-them-view',
  templateUrl: './profile-them-view.component.html',
  styleUrls: ['./profile-them-view.component.scss']
})
export class ProfileThemViewComponent implements OnInit {

  public token: string;
  public profiles: MemberItem[];
  public key: string = "THEM_VIEW_ME";
