...
@Component({
  selector: 'app-profile-wating-chat',
  templateUrl: './profile-wating-chat.component.html',
  styleUrls: ['./profile-wating-chat.component.scss']
})
export class ProfileWatingChatComponent implements OnInit {

  public token: string;
  public profiles: MemberItem[];
  public key: string = "MY_CONTACTS_REQUEST";
