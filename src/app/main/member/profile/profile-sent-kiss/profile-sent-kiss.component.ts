...
@Component({
  selector: 'app-profile-sent-kiss',
  templateUrl: './profile-sent-kiss.component.html',
  styleUrls: ['./profile-sent-kiss.component.scss']
})
export class ProfileSentKissComponent implements OnInit {

  public token: string;
  public profiles: MemberItem[];
  public key: string = "ME_WINK_THEM";
