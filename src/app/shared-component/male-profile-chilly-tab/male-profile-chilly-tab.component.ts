...
@Component({
  selector: 'app-male-profile-chilly-tab',
  templateUrl: './male-profile-chilly-tab.component.html',
  styleUrls: ['./male-profile-chilly-tab.component.scss']
})
export class MaleProfileChillyTabComponent implements OnInit {
