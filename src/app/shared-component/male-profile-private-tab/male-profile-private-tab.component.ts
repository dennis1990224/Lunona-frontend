...
@Component({
  selector: 'app-male-profile-private-tab',
  templateUrl: './male-profile-private-tab.component.html',
  styleUrls: ['./male-profile-private-tab.component.scss']
})
export class MaleProfilePrivateTabComponent implements OnInit {
  ...
  public updatePrivatePhoto(): void {
